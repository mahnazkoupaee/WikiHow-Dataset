...
for row in range(rows):
    abstract = Data.iloc[row]['headline']      # headline is the column representing the summary sentences
    article = Data.iloc[row]['text']           # text is the column representing the article
